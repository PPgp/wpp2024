...
# 5-year projection
tfr <- data.table::fread('tfrprojMed5.txt', sep = "\t")[, country := NULL]
tfr.low <- data.table::fread('tfrprojLow5.txt', sep = "\t")[, country := NULL]
tfr.high <- data.table::fread('tfrprojHigh5.txt', sep = "\t")[, country := NULL]
tfr80l <- data.table::fread('tfrproj80l5.txt', sep = "\t")[, country := NULL]
tfr80u <- data.table::fread('tfrproj80u5.txt', sep = "\t")[, country := NULL]
tfr95l <- data.table::fread('tfrproj95l5.txt', sep = "\t")[, country := NULL]
tfr95u <- data.table::fread('tfrproj95u5.txt', sep = "\t")[, country := NULL]
